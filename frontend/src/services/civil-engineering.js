...
const getCivilProjectItems = async () => {
  try {
...
const getCivilProjectItemById = async (id) => {
  try {
...
const createCivilProjectItem = async (data) => {
  try {
...
const updateCivilProjectItem = async (id, data) => {
  try {
...
const deleteCivilProjectItem = async (id) => {
  try {
